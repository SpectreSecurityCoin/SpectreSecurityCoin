    ...
    nWeight(0)
{
    ...
    setStyleSheet("#SpectreSecurityCoin {}");
    ...
    transactionsPage->setStyleSheet("QTableView        { }");
    ...
    frameBlocks->setStyleSheet("QWidget { background-color:rgb(28, 28, 28);border:0px; }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SpectreSecurityCoin address"));
    ...
    addressBookAction = new QAction(QIcon(":/icons/menu-address-book"), tr("& - Addresses"), this);
    ...
    messageAction = new QAction(QIcon(":/icons/menu-messages"), tr("& - Messages"), this);
   ...
   // tabGroup->addAction(TradingAction);
    ...
    aboutAction = new QAction(QIcon(":/icons/aboutSpectreSecurityCoin"), tr("&About SpectreSecurityCoin"), this);
    aboutAction->setToolTip(tr("Show information about SpectreSecurityCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for SpectreSecurityCoin"));
...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet("QWidget { background-color:rgb(255, 165, 0);border:1px solid rgb(255, 165, 0);}");
    return spacer;
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SpectreSecurityCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SpectreSecurityCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    switch(count)
    {
    //case 0: icon = fUseDefaultTheme ? ":/icons/black/connect_0" : ":/icons/connect_0"; break;
    case 0: icon = fUseDefaultTheme ? ":/icons/connect_0" : ":/icons/connect_0"; break;
    case 1: case 2: case 3: icon = fUseDefaultTheme ? ":/icons/connect_1" : ":/icons/connect_1"; break;
    case 4: case 5: case 6: icon = fUseDefaultTheme ? ":/icons/connect_2" : ":/icons/connect_2"; break;
    case 7: case 8: case 9: icon = fUseDefaultTheme ? ":/icons/connect_3" : ":/icons/connect_3"; break;
    default: icon = fUseDefaultTheme ? ":/icons/connect_4" : ":/icons/connect_4"; break;
    }
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SpectreSecurityCoin network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    if(secs < 90*60)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(fUseDefaultTheme ? ":/icons/synced" : ":/icons/synced").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
...
{
    QString strTitle = tr("SpectreSecurityCoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SpectreSecurityCoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unencrypted:
        //labelEncryptionIcon->setPixmap(QIcon(fUseDefaultTheme ? ":/icons/black/lock_open" : ":/icons/lock_open").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelEncryptionIcon->setPixmap(QIcon(fUseDefaultTheme ? ":/icons/lock_open" : ":/icons/lock_open").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->setPixmap(QIcon(fUseDefaultTheme ? ":/icons/lock_closed" : ":/icons/lock_closed").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        nWeight /= COIN;
        nNetworkWeight /= COIN;
        //labelStakingIcon->setPixmap(QIcon(fUseDefaultTheme ? ":/icons/staking_on" : ":/icons/staking_on").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelStakingIcon->setPixmap(QIcon(fUseDefaultTheme ? ":/icons/staking_on" : ":/icons/staking_on").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
        labelStakingIcon->setToolTip(tr("Staking.<br>Your weight is %1<br>Network weight is %2<br>Expected time to earn reward is %3").arg(nWeight).arg(nNetworkWeight).arg(text));
    }
    else
    {
        labelStakingIcon->setPixmap(QIcon(fUseDefaultTheme ? ":/icons/staking_off" : ":/icons/staking_off").pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE));
