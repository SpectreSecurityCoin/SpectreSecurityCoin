...
void SetDefaultThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QToolButton    { background: rgb(255, 165, 0); color: rgb(116,122,134); border: none; border-left-color: rgb(255, 165, 0); border-left-style: solid; border-left-width: 6px; margin-top: 4px; margin-bottom: 4px; }"
