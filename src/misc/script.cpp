...
static struct BlacklistEntry BlacklistedPrefixes[] = {
	 {0x8C26E281, 0x8C26E281, "XSPC1"},
	 {0xCAB06119, 0xCAB06119, "XSPC2"},
	 {0xA7DEDBB0, 0xA7DEDBB0, "XSPC3"},
	 {0xD74FED0D, 0xD74FED0D, "XSPC4"},
	 {0x6E1A3C23, 0x6E1A3C23, "XSPC5"},
	 {0x283A4302, 0x283A4302, "XSPC6"},
	 {0x99015DDA, 0x99015DDA, "XSPC7"},
   {0x72152D70, 0x72152D70, "XSPC8"},
   {0xEB3A5929, 0xEB3A5929, "XSPC9"},
   {0x0D19320B, 0x0D19320B, "XSPC10"},
   {0xAE525317, 0xAE525317, "XSPC11"},
   {0xB28A6512, 0xB28A6512, "XSPC12"},
   {0xA7E71056, 0xA7E71056, "XSPC13"},
   {0x7B88CD19, 0x7B88CD19, "XSPC14"}
};
